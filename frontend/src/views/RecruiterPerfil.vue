          ...
          <div class="vagas-content">
            <div class="profile-card">
              <div class="profile-card-header">
                ...
                <h3>{{ userRecruiter.name }}</h3>
                <p>{{ userRecruiter.email }}</p>
              </div>
              <div class="profile-card-body">
                <h4>Informações Adicionais</h4>
                <ul>
                  <li><strong>Tipo de Usuário:</strong> Recruiter</li>
                  <li><strong>Data de Criação:</strong> {{ new Date(userRecruiter.created_at).toLocaleDateString() }}</li>
                </ul>
              </div>
            </div>
